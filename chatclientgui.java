...
public class chatclientgui
{
    ...
    {
    	MainWindow.setBackground(new java.awt.Color(255, 0, 0 ));
    	MainWindow.setSize(500, 320);
    	MainWindow.getContentPane().setLayout(null);

    	B_SEND.setBackground(new java.awt.Color(255,255,255));
 ...
 {
 	B_SEND.addActionListener((java.awt.event.ActionEvent evt) -> {
            ACTION_B_SEND();
         });
 B_DISCONNECT.addActionListener((java.awt.event.ActionEvent evt) -> {
     ACTION_B_DISCONNECT();
         });
 	B_CONNECT.addActionListener((java.awt.event.ActionEvent evt) -> {
            BuildLogInWindow();
         });
 	B_HELP.addActionListener((java.awt.event.ActionEvent evt) -> {
            ACTION_B_HELP();
         });
        B_ABOUT.addActionListener((java.awt.event.ActionEvent evt) -> {
            ACTION_B_HELP();
         });
 }
